                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav py-0">
                            ...
                            <a href="civilcontact.php" class="nav-item nav-link active">Contact</a>
                        </div>
                        <div class="nav-item dropdown">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="contact-form bg-secondary rounded p-5">
                        <div id="success"></div>
                        <form action="contactcivil.php" method="post" name="sentMessage" id="contactForm" novalidate="novalidate">
                            <select class="custom-select border-0 px-4" name="course" id="course" >
                                <option selected>Select Your Course</option>
                                <option value="06">CIVIL COURSE</option>
