                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav py-0">
                            ...
                            <a href="computerabout.php" class="nav-item nav-link active">About</a>
...
"><i class="fab fa-instagram"></i></a>
                    ...
                    <div class="col-md-6 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            ...
                            <a class="text-white mb-2" href="javascript.php"><i class="fa fa-angle-right mr-2"></i>Java
                                Script</a>
                            <a class="text-white mb-2" href="html.php"><i class="fa fa-angle-right mr-2"></i>HTML</a>
                            <a class="text-white mb-2" href="my_sql.php"><i
                                    class="fa fa-angle-right mr-2"></i>My_Sql</a>
