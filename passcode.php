              ...
              <div class="panel-body">
                <div class="text-center">
                  ...
                  <div class="panel-heading">
                    <h2 class="text-center">Did you get the code?</h2>
                    <p>You can enter your code here.</p>
                  </div>
                  <div class="panel-body">
                    <form id="register-form" role="form" action="resetpassword.php" autocomplete="off" class="form" method="post">
                      <div class="form-group">
                        <div class="input-group">
                          <span class="input-group-addon"><i class="glyphicon glyphicon-envelope color-blue"></i></span>
                          <input type="text" name="code" placeholder="Enter your code here" class="form-control"  type="email" required>
                        </div>
                      </div>
                      <div class="form-group">
