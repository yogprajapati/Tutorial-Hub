                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav py-0">
                            ...
                            <a href="computercontact.php" class="nav-item nav-link active">Contact</a>
                        </div>
                        <div class="nav-item dropdown">
                            <a href="#" class="btn btn-primary py-2 px-4 ml-auto d-none d-lg-block" data-toggle="dropdown">Profile</a>
                            <div class="dropdown-menu rounded-0 m-0">
...
echo '<script>
                        setTimeout(function() {
                            window.location.href = "computercontact.php";
                        }, 1000);
               </script>';
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="contact-form bg-secondary rounded p-5">
                        <div id="success"></div>
                        <form action="computerquery.php" method="post" name="sentMessage" id="contactForm" novalidate="novalidate">
