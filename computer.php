...
<body>
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav py-0">
                            <a href="computerindex.php" class="nav-item nav-link">Home</a>
                            <a href="computerabout.php" class="nav-item nav-link">About</a>
                            <a href="computer.php" class="nav-item nav-link active">Courses</a>
                            <!-- <a href="computerteacher.php" class="nav-item nav-link">Teachers</a> -->
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Blog</a>
                                <div class="dropdown-menu rounded-0 m-0">
                                    <a href="computerblog.php" class="dropdown-item">Blog List</a>
                                    
                                </div>
                            </div>
                            <a href="computercontact.php" class="nav-item nav-link">Contact</a>
                        </div>
        ...
        <div class="container">
            <div class="d-flex flex-column justify-content-center" style="min-height: 300px">
                ...
                <div class="d-inline-flex text-white">
                    ...
                    <p class="m-0 text-uppercase">COMPUTER</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            <div class="text-center mb-5">
                <h5 class="text-primary text-uppercase mb-3" style="letter-spacing: 5px;">COMPUTER</h5>
            ...
            <!-- <div class="row">
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="cat-item position-relative overflow-hidden rounded mb-2">
                        ...
                        <a class="cat-overlay text-white text-decoration-none" target="_blank" href="PRACTICAL - 8.pdf">
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="cat-item position-relative overflow-hidden rounded mb-2">
                        ...
                        <a class="cat-overlay text-white text-decoration-none" target="_blank" href="https://drive.google.com/file/d/16KOFXK-HhlH4q-jNxh4zqf6qey7uM2Xe/view?usp=drivesdk">
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="cat-item position-relative overflow-hidden rounded mb-2">
                        ...
                        <a class="cat-overlay text-white text-decoration-none" href="https://drive.google.com/file/d/16SbKcwd10wLEUx6Itx6JUTjmX3Yqlgwa/view?usp=drivesdk">
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="cat-item position-relative overflow-hidden rounded mb-2">
                        ...
                        <a class="cat-overlay text-white text-decoration-none" href="https://drive.google.com/file/d/16ns-oeZZat-PNQxtSQ68AQVYefksNzcW/view?usp=drivesdk">
                            <h4 class="text-white font-weight-medium">My_Sql</h4>
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="cat-item position-relative overflow-hidden rounded mb-2">
                        ...
                        <a class="cat-overlay text-white text-decoration-none" href="https://drive.google.com/file/d/16nFX9DOfT0n8vK-temcCHHV7tUTfRSIF/view?usp=drivesdk">
                            <h4 class="text-white font-weight-medium">Css</h4>
    ...
    <div class="feedback-box"><form action="feedbackComputer.php" method="post">
...
<br>
<?php
//   $Q_ID = 'Q_ID'; // Replace with actual value or pass as parameter
//   $sql = "SELECT query_table.QUERY_TEXT, answer_table.ANSWER_TEXT, user_table.U_NAME, user_table.U_EMAIL
//   FROM query_table
//   JOIN answer_table ON query_table.Q_ID = answer_table.A_ID
//   JOIN user_table ON answer_table.U_ID = user_table.U_ID
//   WHERE query_table.Q_ID = '$Q_ID'"; // Add table name prefix to Q_ID
