                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav py-0">
                            ...
                            <a href="computer.php" class="nav-item nav-link">Courses</a>
                        ...
                        <div class="nav-item dropdown">
                            <a href="#" class="btn btn-primary py-2 px-4 ml-auto d-none d-lg-block"
            ...
            <div class="row pb-3">
                <div class="col-lg-4 mb-4">
                    <div class="blog-item position-relative overflow-hidden rounded mb-2">
                        <img class="img-fluid" src="img/500.webp" alt="">
                        <a class="blog-overlay text-decoration-none" href="blog1.html">
                            <h5 class="text-white mb-3">ChatGPT</h5>
                            <p class="text-primary m-0">Mar 05, 2023</p>
                        </a>
                    </div>
                </div>
                <div class="col-lg-4 mb-4">
                    <div class="blog-item position-relative overflow-hidden rounded mb-2">
                        <img class="img-fluid" src="img/flutter-vs-android.jpg" alt="">
                        <a class="blog-overlay text-decoration-none" href="blog2.html">
                            <h5 class="text-white mb-3">Android Vs Flutter</h5>
                            <p class="text-primary m-0">Mar 06, 2023</p>
                        </a>
                    </div>
                </div>
                <div class="col-lg-4 mb-4">
                    <div class="blog-item position-relative overflow-hidden rounded mb-2">
                        <img class="img-fluid" src="img/wallpapersden.com_batman-amoled-fanart_1920x1080.jpg" alt="">
