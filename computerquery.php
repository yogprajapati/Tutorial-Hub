...
//     header("location: computercontact.php?remarks=success");
// }  if (empty($_POST['message']) ) {
//     // Display an error message if any of the required fields are empty
//     $e=mysqli_error($con);
//     header("location: computercontact.php?remarks=failed");
// } else {
...
if (empty($_POST['message']) ) {
    ...
    header("location: computercontact.php?remarks=error");
}
?>