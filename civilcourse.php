...
<body>
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav py-0">
                            ...
                            <a href="civilabout.php" class="nav-item nav-link">About</a>
                            <a href="civilcourse.php" class="nav-item nav-link active">Courses</a>
        ...
        <div class="container">
            <div class="d-flex flex-column justify-content-center" style="min-height: 300px">
                ...
                <div class="d-inline-flex text-white">
                    ...
                    <p class="m-0 text-uppercase">CIVIL DEPARTMENT</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            <div class="text-center mb-5">
                <h5 class="text-primary text-uppercase mb-3" style="letter-spacing: 5px;">CIVIL DEPARTMENT</h5>
                <h1>Explore Top Subjects</h1>
            </div>
            <center>
                <form method="post" action="civil.php">
                    <input type="hidden" name="pdf_id" value="1">
                    <button class="fillin" type="submit" name="retrieve_pdf">CIVIL COURSE</button>
                </form>
            </center> <br>
                </div>
	          </div> -->
             <center> <div class="container">
                <div class="photo">
                    <img src="https://thumbs.dreamstime.com/b/civil-engineering-logo-illustration-bridge-silhouette-51346158.jpg" width="250" height="250" alt="JAVASCRIPT Photo">
                </div><br>
                <div class="info">
                    <h2>About CIVIL</h2>
    ...
    <!-- Category Start -->
    <div class="feedback-box"><form action="civilfeedback.php" method="post">
...
echo '<script>
                        setTimeout(function() {
                            window.location.href = "civilcourse.php";
                        }, 1000);
               </script>';
